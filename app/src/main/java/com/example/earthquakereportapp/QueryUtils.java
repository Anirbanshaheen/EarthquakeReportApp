...
//            "{\"type\":\"Feature\",\"properties\":{\"mag\":6,\"place\":\"Pacific-Antarctic Ridge\",\"time\":1451986454620,\"updated\":1459202978040,\"tz\":-540,\"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004bgk\",\"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004bgk&format=geojson\",\"felt\":0,\"cdi\":1,\"mmi\":0,\"alert\":\"green\",\"status\":\"reviewed\",\"tsunami\":0,\"sig\":554,\"net\":\"us\",\"code\":\"10004bgk\",\"ids\":\",us10004bgk,gcmt20160105093415,\",\"sources\":\",us,gcmt,\",\"types\":\",cap,dyfi,geoserve,losspager,moment-tensor,nearby-cities,origin,phase-data,shakemap,\",\"nst\":null,\"dmin\":30.75,\"rms\":0.67,\"gap\":71,\"magType\":\"mww\",\"type\":\"earthquake\",\"title\":\"M 6.0 - Pacific-Antarctic Ridge\"},\"geometry\":{\"type\":\"Point\",\"coordinates\":[-136.2603,-54.2906,10]},\"id\":\"us10004bgk\"}],\"bbox\":[-153.4051,-54.2906,10,158.5463,59.6363,582.56]}";
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try {
            ...
            Log.e("Url Finder log", "Problem building the URL ", e);
        }
        return url;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e("Response code log", "Error response code: " + urlConnection.getResponseCode());
            }
        } catch (IOException e) {
            Log.e("Failed to get j.res log", "Problem retrieving the earthquake JSON results.", e);
        } finally {
...
//                JSONObject properties = currentEarthquake.getJSONObject("properties");
                ...
                String mag = String.valueOf(currentEarthquake.getJSONObject("properties").getDouble("mag"));

                String place = currentEarthquake.getJSONObject("properties").getString("place");

                String time = String.valueOf(currentEarthquake.getJSONObject("properties").getLong("time"));

                String url = currentEarthquake.getJSONObject("properties").getString("url");
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl){
        ...
        // Pause for 2 Sec as a result we can see the loading bar
        try {
            Thread.sleep(1000);
        ...
        try {
            ...
            Log.e("Log Tag ","Problem making the HTTP request." + e);
        }

        // Extract related field from the json response
